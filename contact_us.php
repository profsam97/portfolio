...
<section id="showcase">
  ...
  <ul class="nav nav-pills flex-column ">
              ...
              <li class="nav-item whit">
                  <a class="nav-link text-dark " href="contact_us.php">
                    <b>CONTACT</b> 
                    </a>
              </li>
              <li class="nav-item  opac">
                ...
                <div class="col">
                  <div class="form-group">
                    <div class="input-group input-group-lg">
                      ...
                      <input type="text" name="username" class="form-control   text-dark" placeholder="Name">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                 ...
                 <div class="col-md-12">
                  <div class="form-group">
                    <div class="input-group input-group-lg">
                      ...
                      <textarea name="message" class="form-control  text-dark" placeholder="Message"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                        <button class="btn btn-outline-success btn-block click" name="submit">
                            Submit
                        </button>                       
                        </div>
                      </div>
      ...
      <div class="col-lg-8 sec-overlay d-md-none">
        <div class="car m-1 p-1">
          <div class="card-body">
            <h4 class="text-center display-4">
              Get in Touch
            </h4>
